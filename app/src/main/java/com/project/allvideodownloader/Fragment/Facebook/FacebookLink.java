...
public class FacebookLink extends Fragment{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        facebookWebView = binding.webViewLinkId;


        binding.browseId.setText("Browse Facebook");
    ...
    private void checkLink() {
        try {
            ...
            webSetting = facebookWebView.getSettings();
            webSetting.setJavaScriptEnabled(true);
            facebookWebView.getSettings().setDisplayZoomControls(true);
            facebookWebView.getSettings().setDisplayZoomControls(true);
            shouldOverrideUrlLoading(facebookWebView, "https://facebook.com/");
            if (isLoaded) {
                facebookWebView.setWebViewClient(new WebViewClient(){
                    @Override
