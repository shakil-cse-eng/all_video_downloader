...
public class InstagramLink extends Fragment{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        instagramWebView = binding.webViewLinkId;

        binding.browseId.setText("Browse Instagram");
    ...
    private void checkLink() {
        try {
            ...
            webSetting = instagramWebView.getSettings();
            webSetting.setJavaScriptEnabled(true);
            instagramWebView.getSettings().setDisplayZoomControls(true);
            instagramWebView.getSettings().setDisplayZoomControls(true);
            shouldOverrideUrlLoading(instagramWebView, "https://www.instagram.com/");
            if (isLoaded) {
                instagramWebView.setWebViewClient(new WebViewClient(){
                    @Override
